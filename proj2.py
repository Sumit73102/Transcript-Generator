...
def input_range():
    ...
    f.close()
    return render_template("upload.html", message="Input taken, you can go back :)")
...
def generate_transcript_range():   # for generating transcripts for a range
    ...
    if (len(non_existing)!=0):
        return render_template("forward.html", message="Transcripts generated successfully, you can go back :)", ls=non_existing, mess="These roll numbers do no exist")
    return render_template("forward.html", message="Transcripts generated successfully, you can go back :)", ls=non_existing)
